...
set network.singbox_tun=interface
set network.singbox_tun.proto='none'
...
set network.tun0_download.name='tun0_download'
set network.tun0_download.out='singbox_tun'
set network.tun0_download.priority='90'
set network.tun0_download.lookup='vpn'
...
set firewall.tun_client_flows=rule
set firewall.tun_client_flows.name='Allow TUN TCP client flows'
set firewall.tun_client_flows.src='tun'
set firewall.tun_client_flows.src_ip='172.16.250.2'
set firewall.tun_client_flows.dest_ip='172.16.250.1'
set firewall.tun_client_flows.proto='tcp'
set firewall.tun_client_flows.dest_port='32768-60999'
set firewall.tun_client_flows.target='ACCEPT'
set firewall.tun_client_flows.family='ipv4'
